  ...
  async formathelp(target, room, user, connection, cmd) {
    ...
    if (format) {
      ...
      if (data) {
        ...
        descHtml.push(`This format has no resources linked on its <a href="https://www.smogon.com/dex/${genID[format.gen - 1] || "sv"}/formats/">Smogon Dex page</a>. Please contact a <a href="https://www.smogon.com/forums/forums/757/">C&amp;C Leader</a> to resolve this. Alternatively, if this format can't have a page on the Smogon Dex, message <username>dhelmise</username>.<br />`);
      }
