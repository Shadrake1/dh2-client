...
const Formats = [
    ...
    onValidateTeam(team, format) {
      ...
      for (const set of team) {
        ...
        if (speciesTable[template.id]) {
          return ["You are limited to one of each Pok\xE9mon by Species Clause (except for different formes). ", "You have more than one " + template.id + "."];
        }
  ...
  },
  {
    ...
    banlist: [
      ...
      "Blue Orb",
      "Red Orb",
      //this is just copied from ANL's lol
      "Beedrill-Mega",
      "Pidgeot-Mega"
      //?????
    ],
  ...
  },
  {
    ...
    desc: [
      "<b>DLCmons</b>: This Pet Mods aims at creating DLCs for Pokemon games, like how the Expansion Pass worked for Galar. This will include adding existing Pokemon that are not in the chosen regional Pokedex, adding new ones, creating regional formes, items, moves... This will be a pretty diverse project!"
    ],
    threads: [
    ...
    onValidateTeam(team, format) {
      ...
      for (const set of team) {
        ...
        if (template.tier !== "Kalos" && template.tier !== "Kalos (NFE)") {
          return [set.species + " is not a part of the Kalos Pok\xE9dex."];
        }
      }
    },
    mod: "dlcmons"
  ...
  {
    name: "[Gen 9] Eternal Pok\xE9mon",
    mod: "eternalpokemon",
    desc: "A Pet Mod that aims to give Eternal Floette-like formes to other NFE Pok\xE9mon.",
    ruleset: ["Standard NatDex", "OHKO Clause", "Evasion Moves Clause", "Evasion Items Clause", "Species Clause", "Sleep Moves Clause", "Z-Move Clause", "Data Mod", "Terastal Clause", "Picked Team Size = 6"],
    // temporarily asks for team order until Magikarp-Eternal situation is solved 
    threads: [
      `&bullet; <a href="https://www.smogon.com/forums/threads/eternal-pok%C3%A9mon.3755140/">Eternal Pok\xE9mon on Smogon Forums</a>`
    ],
    ...
    onValidateTeam(team, format) {
      ...
      for (const set of team) {
        let template = this.dex.species.get(set.species);
        if (template.tier == "Banned")
          return [set.species + " is banned in Eteral Pok\xE9mon"];
        if (template.tier == "WIP")
          return [set.species + " has some coding challenges, so it's not allowed yet!"];
        if (!allowedTiers.includes(template.tier)) {
          return [set.species + " is not available in Eternal Pok\xE9mon."];
        }
      }
    }
  },
  {
    ...
    onValidateTeam(team, format, teamHas) {
      ...
      if (era.length > 1)
        return ["Each Pokemon needs to be from the same era."];
    }
  },
  {
  ...
  },
  {
    ...
    banlist: [],
    unbanlist: ["Last Respects", "Shed Tail", "Bright Powder", "Razor Fang", "Arena Trap", "Moody", "Shadow Tag"],
    //Uber unbans
    onValidateTeam(team, format) {
      let speciesTable = {};
  ...
  },
  {
    ...
    mod: "genxbrunica",
    ruleset: ["Standard NatDex", "OHKO Clause", "Evasion Clause", "Species Clause", "Terastal Clause", "Sleep Clause Mod", "Z-Move Clause", "Mega Data Mod", "Data Mod"],
    banlist: ["Akulut", "Kaiwakaw", "Lutakon", "Lutakon-Awakened", "Tinozous"],
    //Ubers
    onValidateTeam(team, format) {
      let speciesTable = {};
  ...
  },
  {
    ...
    mod: "genxdesvega",
    ruleset: ["Standard NatDex", "OHKO Clause", "Evasion Clause", "Species Clause", "Terastal Clause", "Sleep Clause Mod", "Z-Move Clause", "Mega Data Mod", "Data Mod"],
    banlist: ["Ursaluna-Bloodmoon", "Naganadel", "Arcognition", "Janutcher", "Virulope"],
    //Ubers
    onValidateTeam(team, format) {
      let speciesTable = {};
  ...
  },
  {
    ...
    banlist: [
      ...
      "Last Respects",
      "Shed Tail",
      "Blastoise + Parallel Mega Orb",
      "Salamence + Parallel Mega Orb",
      "Gengar + Parallel Mega Orb",
      "Alakazam + Parallel Mega Orb",
      "Blaziken + Parallel Mega Orb",
      "Lucario + Parallel Mega Orb",
      "Gallade + Parallel Mega Orb",
      "Special Tera Orb"
    ],
  ...
  },
  {
    name: "[Gen 9] Ironmons",
    desc: [
      "<b>Ironmons</b>: A OU based Pet Mod that aims to create new Paradox forms for existing Pokemon, both past and future."
    ],
    threads: [
  ...
  },
  {
    ...
    desc: [
      "<b>Megas for All</b>: A Pet Mod that aims to create unique Mega Evolutions for every fully evolved Pok\xE9mon. Current season is focused on the Paldea dex, pre DLC!"
    ],
    threads: [
    ...
    onValidateSet(set) {
      ...
      if (item.megaEvolves === species.name) {
        if (item.megaStone && this.dex.species.get(item.megaStone).tier !== "Mega")
          return [item.name + " is not a legal Mega Stone."];
      }
    },
    onHitPriority: 1,
  ...
  },
  {
    ...
    desc: [
      "Megas for All v7 but it's a VGC format"
    ],
    threads: [
      `&bullet; <a href="https://www.smogon.com/forums/threads/3671140/">Megas for All v7 on Smogon Forums</a>`,
      `&bullet; <a href="https://docs.google.com/spreadsheets/d/1TdeAUUtjh0f_tcIBllbF_imgepwV-dV2YomoTCRlPgI/edit?usp=sharing">Spreadsheet</a>`,
  ...
  },
  {
    ...
    desc: [
      "<b>Megas for All</b>: A Pet Mod that aims to create unique Mega Evolutions for every fully evolved Pok\xE9mon. Plays like National Dex, just with more Megas."
    ],
    threads: [
  ...
  },
  {
    name: "[Gen 9] MetaMons",
    desc: [
      "In this Pet Mod, we will aim to create a decently-sized micrometa that will expand in the unique niches of some Pok\xE9mon, giving them the spotlight after all the time they have been waiting."
    ],
    threads: [
  ...
  },
  {
    ...
    desc: "<b>[Gen 9] Paleomons</b>: In this mod, we will be creating an SV OU-based micrometa of Pok\xE9mon based on real critters from the Paleozoic, Mesozoic, and Cenozoic eras.",
    threads: [
  ...
  },
  {
    ...
    banlist: [
      ...
      "Light Clay",
      "Melmetal-Gmax",
      "Ogerpon-Hearthflame + Close Combat",
      "Ogerpon-Hearthflame + Rock Blast",
      "Ogerpon-Wellspring + Close Combat",
      "Ogerpon-Wellspring + Rock Blast",
      "Ogerpon-Cornerstone + Rock Blast",
      "Volcarona",
      "Roaring Moon",
      "Espathra",
      "Baxcalibur"
  ...
  // Start
  {
    name: "[Gen 9] VGC 20xx",
    desc: [
      "Custom VGC format by sugarbear"
    ],
    threads: [
  ...
  },
  {
    ...
    onSwitchIn(pokemon) {
      if (pokemon.species.id === "extremeribbit")
        return;
  ...
  },
  {
    ...
    banlist: [
      ...
      "Red Orb",
      "Baton Pass",
      "Ninjacross + Heracronite",
      "Kokovoir + Gardevoirite",
      "Salamencite",
      "Charizardite Y",
      "Blue Orb",
      "Wishirupti + Cameruptite",
      "Mawilite",
      "Gastrocham + Medichamite",
      "Manectite",
      "Herasir + Heracronite",
      "Herasir + Pinsirite",
      "Light Ball",
  ...
  */
  {
    ...
    desc: [
      "<b>Megas for All</b>: A Pet Mod that aims to create unique Mega Evolutions for every fully evolved Pok\xE9mon. Current season is focused on the Kalos dex!"
    ],
    threads: [
      `&bullet; <a href="https://www.smogon.com/forums/threads/3671140/">Megas for All v7 on Smogon Forums</a>`,
      `&bullet; <a href="https://docs.google.com/spreadsheets/d/1TdeAUUtjh0f_tcIBllbF_imgepwV-dV2YomoTCRlPgI/edit?usp=sharing">Spreadsheet</a>`,
  	...
  	*/
  {
    ...
    desc: [
      "Megas for All v7 but it's Custom Game. Add custom typings and stats via Sandbox Mod!"
    ],
    threads: [
  ...
  },
  {
    ...
    onValidateSet(set) {
      ...
      if (item.megaStone)
        return [`${set.name || set.species} is not currently allowed to Mega Evolve.`];
    },
  ...
  },
  {
    ...
    onValidateTeam(team, format) {
      let speciesTable = {};
      const customTiers = ["Pok\xE9mon of the Day!", "Evo!", "(Prevo)"];
      for (const set of team) {
        let template = this.dex.species.get(set.species);
    ...
    onValidateSet(set) {
      const item = this.dex.items.get(set.item);
      if (item.megaStone)
        return [`${set.name || set.species} is not allowed to Mega Evolve.`];
    },
  ...
  },
  {
    ...
    checkCanLearn(move, species, lsetData, set) {
      ...
      if (problem && move.name !== "Tera Blast")
        return problem;
      return null;
    },
    onValidateSet(set) {
  ...
  },
  {
    ...
    desc: [
      "Fusion Evolution but it's a VGC format, and a solomod run by AquaticPanic"
    ],
    threads: [
  ...
  },
  {
    ...
    onValidateTeam(team, format) {
      let speciesTable = {};
      let allowedTiers = ["MD", "MD NFE", "MD Ubers", "EXP2"];
      for (const set of team) {
        let template = this.dex.species.get(set.species);
        if (!allowedTiers.includes(template.tier)) {
          return [set.species + " is not legal in Maadowr."];
  ...
  },
  {
    ...
    onValidateTeam(team, format, teamHas) {
      ...
      if (era.length > 1)
        return ["Each Pokemon needs to be from the same category."];
    }
  },
  {
    ...
    onValidateTeam(team, format) {
      let speciesTable = {};
      let allowedTiers = ["MHUbers", "MHOU", "MHUU", "MHRU"];
      for (const set of team) {
        let template = this.dex.species.get(set.species);
        if (!allowedTiers.includes(template.tier)) {
  ...
  },
  {
    ...
    onValidateTeam(team, format) {
      let speciesTable = {};
      let allowedTiers = ["MHOU", "MHUU", "MHRU"];
      for (const set of team) {
        let template = this.dex.species.get(set.species);
        if (!allowedTiers.includes(template.tier)) {
  ...
  {
    name: "[Gen 9] Pok\xE9mon North, South, East, West",
    teambuilderFormat: "National Dex",
    ...
    onValidateTeam(team, format) {
      ...
      for (const set of team) {
        let template = this.dex.species.get(set.species);
        if (!allowedTiers.includes(template.tier)) {
          return [set.species + " is not legal in Pok\xE9mon North, South, East, and West."];
        }
      }
    }
  },
  {
    name: "[Gen 9] Pok\xE9mon Go! Go! Tamagotchi!",
  ...
  },
  {
    ...
    unbanlist: ["Annihilape", "Dragapult", "Gholdengo", "Gouging Fire", "Kingambit", "Melmetal", "Palafin", "Regieleki", "Roaring Moon", "Shedinja", "Terapagos", "Ursaluna-Bloodmoon", "Walking Wake"],
    teambuilderFormat: "National Dex"
  },
  {
  ...
  },
  {
    ...
    onValidateTeam(team, format) {
      ...
      let ff = false;
      for (const set of team) {
        if (set.species === "Flutter Mane")
          f = true;
        else if (set.species === "Flutter Mane 2")
          ff = true;
        if (f && ff)
          return ["Did you think you could bring two Flutter Manes to a game? Are you stupid?"];
        let template = this.dex.species.get(set.species);
        if (template.tier !== "SM") {
  ...
  },
  {
    ...
    onValidateTeam(team, format) {
      let speciesTable = {};
      let allowedTiers = ["Upside Down OU", "Upside Down NFE", "Upside Down LC"];
      for (const set of team) {
        let template = this.dex.species.get(set.species);
        if (!allowedTiers.includes(template.tier)) {
  ...
  },
  {
    ...
    onBeforeSwitchIn(pokemon) {
      ...
      if (!format.getSharedPower)
        format = this.dex.formats.get("gen9ironfistsharedpower");
  ...
  },
  {
    ...
    onAfterMoveSecondarySelf(source, target, move) {
      if (!move || !target)
        return;
      if (source.side.getSideCondition("maxmeter1") || source.side.getSideCondition("maxmeter2") || source.side.getSideCondition("maxmeter3") || source.side.getSideCondition("maxmeter4") || source.side.getSideCondition("maxmeter5"))
        return;
  ...
  },
  {
    ...
    onValidateTeam(team, format) {
      ...
      if (combinationTest.length > 1) {
        if (combinationTest.includes("Xylomist") && (combinationTest.includes("Yeoxylo") || combinationTest.includes("Xylozop") || combinationTest.includes("Xylyeozop")) || combinationTest.includes("Yeomelt") && (combinationTest.includes("Yeoxylo") || combinationTest.includes("Zopyeo") || combinationTest.includes("Xylyeozop")) || combinationTest.includes("Zoplite") && (combinationTest.includes("Xylozop") || combinationTest.includes("Zopyeo") || combinationTest.includes("Xylyeozop"))) {
  ...
  },
  {
    ...
    mod: "moderngen2birds",
    searchShow: false,
    ruleset: ["Standard", "Z-Move Clause", "!Obtainable Abilities", "Gems Clause"],
    // temporary until I can figure why HAs work in MG3 but not here
    banlist: [
      "Assist",
      "Baton Pass",
      "Arena Trap",
