...
const Moves = {
  ...
  wakeupslap: {
    ...
    basePowerCallback(pokemon, target, move) {
      if (target.status === "slp" || target.hasAbility("comatose") || target.hasAbility("worldofnightmares") || pokemon.hasAbility("worldofnightmares"))
  ...
  ultrasleep: {
    //this move is only for worldofnightmares ability
    num: -9999,
    accuracy: true,
    basePower: 0,
    category: "Status",
  ...
  bodyswap: {
    ...
    onAfterMoveSecondarySelf(pokemon, target, move) {
      if (move.willChangeForme) {
        let hecatiaForme;
        if (pokemon.species.id === "hecatialapislazuli")
          hecatiaForme = "-Earth";
        else if (pokemon.species.id === "hecatiaearth")
          hecatiaForme = "-Moon";
        else
          hecatiaForme = " Lapislazuli";
