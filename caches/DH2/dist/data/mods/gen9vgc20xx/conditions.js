...
const Conditions = {
  ...
  confusion: {
    ...
    onStart(target, source, sourceEffect) {
      if (target.hasType("Bug")) {
        this.add("-immune", target, "[from] Bug typing");
        return false;
      }
  ...
  /*// start: Aegislash-Light is the only Pkm who could get this volatile if hit by Soak
  soaktypedenial: {
  ...
  fungus: {
    ...
    onAfterEachBoost(boost, target, source, effect) {
      ...
      if (!partner || !partner.volatiles["fungus"])
        return;
      const fungusBoost = {};
      let activated = false;
      if (boost.atk !== void 0 && boost.atk < 0) {
        fungusBoost.spa = -boost.atk;
        activated = true;
      }
      if (boost.spa !== void 0 && boost.spa < 0) {
        fungusBoost.atk = -boost.spa;
        activated = true;
      }
      if (boost.def !== void 0 && boost.def < 0) {
        fungusBoost.spd = -boost.def;
        activated = true;
      }
      if (boost.spd !== void 0 && boost.spd < 0) {
        fungusBoost.def = -boost.spd;
        activated = true;
      }
      if (activated) {
