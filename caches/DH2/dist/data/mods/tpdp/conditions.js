...
const Conditions = {
  ...
  calm: {
    ...
    durationCallback(source, effect) {
      if (source?.hasItem(["almightygodstone", "silentgodstone"]))
        return 8;
      if (source.hasAbility("stargazer"))
        return 0;
      return 5;
    },
  ...
  seiryu: {
    ...
    duration: 5,
    durationCallback(source, effect) {
      if (source.hasAbility("timegazer"))
        return 8;
      return 5;
    },
  ...
  suzaku: {
    ...
    onTryHeal(relayVar, target, source, effect) {
      if (target.hasAbility("southernexpanse"))
        return;
  ...
  kohryu: {
    ...
    onModifyMove(move, pokemon, target) {
      ...
      console.log(pokemon);
      if (pokemon.ability.includes(boostAbils))
