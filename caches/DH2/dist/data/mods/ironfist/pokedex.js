...
const Pokedex = {
  ...
  bramblin: {
    ...
    abilities: { 0: "Wind Rider", 1: "!dt air slash", H: "Monster Mash" },
    evos: null
  },
  anarlvet: {
    name: "Anarlvet",
  ...
  feebas: {
    ...
    abilities: { 0: "Fashion icon", 1: "Oblivious", H: "Adaptability" }
  },
  microwave: {
    name: "microwave",
    num: -12,
  ...
  runerigus: {
    ...
    abilities: { 0: "Wandering Spirit", 1: "Monster Mash", H: "Neutralizing Gas" },
    weightkg: 66.6
  },
  crabominable: {
    inherit: true,
  ...
  goomba: {
    ...
    abilities: { 0: "Strong Jaw", 1: "Regenerator", 2: "Fashion icon", H: "Sheer Force", S: "Intimidate" },
    weightkg: 138
  },
  fridgile: {
    name: "Fridgile",
  ...
  silvally: {
    ...
    num: 773,
    fish: true,
    abilities: { 0: "RKS System", H: "Stall" },
  ...
  hitmontop: {
    ...
    abilities: { 0: "Intimidate", 1: "Technician", H: "Skeptic" },
    weightkg: 48
  },
  zelda: {
    name: "Zelda",
  ...
  conquescape: {
    ...
    gender: "N",
    types: ["Ice"],
    baseStats: { hp: 130, atk: 25, def: 59, spa: 116, spd: 170, spe: 75 },
  ...
  enamorustherian: {
    ...
    abilities: { 0: "Overcoat", 1: "Fashion icon", H: "Gex Server" },
    weightkg: 48
  },
  pokestarfisherman: {
  ...
  raccoon: {
    ...
    num: -103,
    types: ["Dark", "Silly"],
    baseStats: { hp: 75, atk: 106, def: 75, spa: 65, spd: 85, spe: 116 },
  ...
  minunandplusled: {
    ...
    baseStats: { hp: 90, atk: 75, def: 75, spa: 120, spd: 120, spe: 135 },
  ...
  carnivineif: {
    ...
    name: "Carnivine-IF",
    types: ["Fairy", "Silly"],
    baseStats: { hp: 109, atk: 117, def: 96, spa: 64, spd: 96, spe: 58 },
  ...
  zoruahisui: {
    ...
    abilities: { 0: "Monster Mash", H: "Illusion" },
    weightkg: 12.5
  },
  wishiwashi: {
    inherit: true,
    ...
    fish: true,
    types: ["Water", "Bug"],
    baseStats: { hp: 51, atk: 42, def: 56, spa: 49, spd: 47, spe: 35 },
  ...
  citrusjams: {
    ...
    baseStats: { hp: 97, atk: 11, def: 40, spa: 111, spd: 83, spe: 103 },
  ...
  tylerthecreator: {
    ...
    gender: "M",
    types: ["Lemon", "Ground"],
    baseStats: { hp: 109, atk: 110, def: 95, spa: 88, spd: 102, spe: 56 },
  ...
  kyogre: {
    ...
    gen: 3,
    types: ["Water"],
    baseStats: { hp: 90, atk: 85, def: 95, spa: 115, spd: 110, spe: 85 },
    abilities: { 0: "Drizzle" },
    weightkg: 430
  },
  upvybones: {
