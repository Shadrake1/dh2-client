...
const Conditions = {
  ...
  nanoboosted: {
    ...
    onEnd(pokemon) {
      ...
      const nanoStats = ["atk", "spa", "def", "spd"];
      for (const statName2 of nanoStats) {
        if (pokemon.boosts[statName2] * mod > 0) {
          pokemon.boosts[statName2] = 0;
          this.add("-setboost", pokemon, statName2, pokemon.boosts[statName2], "[silent]");
        }
      }
    }
  }
