...
const Scripts = {
  ...
  init() {
    for (const i in this.data.FormatsData) {
      if (i.endsWith("gmax"))
        this.modData("FormatsData", i).tier = "TMFE";
    }
  ...
  actions: {
    ...
    modifyDamage(baseDamage, pokemon, target, move, suppressMessages = false) {
      ...
      if (move.forceSTAB || type !== "???" && (pokemon.hasType(type) || pokemon.terastallized && pokemon.getTypes(false, true).includes(type) || isTeraStellar && !pokemon.stellarBoostedTypes.includes(type))) {
        let stab = isTeraStellar && !pokemon.getTypes(false, true).includes(type) ? [4915, 4096] : move.stab || 1.5;
        if ((type === pokemon.terastallized || isTeraStellar && !pokemon.stellarBoostedTypes.includes(type)) && pokemon.getTypes(false, true).includes(type)) {
          stab = stab === 1.75 && !isTeraStellar ? 2.25 : 1.75;
        } else if (pokemon.terastallized && type !== pokemon.terastallized && stab === 2) {
          stab = 1.25;
        }
        baseDamage = this.battle.modify(baseDamage, stab);
        if (isTeraStellar && pokemon.species.name !== "Terapagos-Stellar" && !pokemon.stellarBoostedTypes.includes(type)) {
    ...
    getActiveMaxMove(move, pokemon) {
      ...
      if (move.category !== "Status") {
        if (pokemon.gigantamax && pokemon.canGigantamax) {
          ...
          if (gMaxMove.exists) {
            if (move.name === "Drum Beating" && pokemon.baseSpecies.baseSpecies === "Rillaboom" || move.name === "Frenzy Plant" && pokemon.baseSpecies.baseSpecies === "Venusaur" || move.name === "Blast Burn" && pokemon.baseSpecies.baseSpecies === "Charizard" || move.name === "Hydro Cannon" && pokemon.baseSpecies.baseSpecies === "Blastoise" || move.name === "Pollen Puff" && pokemon.baseSpecies.baseSpecies === "Butterfree" || move.name === "Volt Tackle" && pokemon.baseSpecies.baseSpecies === "Pikachu" || move.name === "Pay Day" && pokemon.baseSpecies.baseSpecies === "Meowth" || move.name === "Dynamic Punch" && pokemon.baseSpecies.baseSpecies === "Machamp" || move.name === "Shadow Ball" && pokemon.baseSpecies.baseSpecies === "Gengar" || move.name === "Crabhammer" && pokemon.baseSpecies.baseSpecies === "Kingler" || move.name === "Freeze-Dry" && pokemon.baseSpecies.baseSpecies === "Lapras" || move.name === "Last Resort" && pokemon.baseSpecies.baseSpecies === "Eevee" || move.name === "Body Slam" && pokemon.baseSpecies.baseSpecies === "Snorlax" || move.name === "Gunk Shot" && pokemon.baseSpecies.baseSpecies === "Garbodor" || move.name === "Double Iron Bash" && pokemon.baseSpecies.baseSpecies === "Melmetal" || move.name === "Pyro Ball" && pokemon.baseSpecies.baseSpecies === "Cinderace" || move.name === "Snipe Shot" && pokemon.baseSpecies.baseSpecies === "Inteleon" || move.name === "Brave Bird" && pokemon.baseSpecies.baseSpecies === "Corviknight" || move.name === "Psychic" && pokemon.baseSpecies.baseSpecies === "Orbeetle" || move.name === "Razor Shell" && pokemon.baseSpecies.baseSpecies === "Drednaw" || move.name === "Tar Shot" && pokemon.baseSpecies.baseSpecies === "Coalossal" || move.name === "Grav Apple" && pokemon.baseSpecies.baseSpecies === "Flapple" || move.name === "Apple Acid" && pokemon.baseSpecies.baseSpecies === "Appletun" || move.name === "Sand Tomb" && pokemon.baseSpecies.baseSpecies === "Sandaconda" || move.name === "Fire Lash" && pokemon.baseSpecies.baseSpecies === "Centiskorch" || move.name === "Overdrive" && pokemon.baseSpecies.baseSpecies === "Toxtricity" || move.name === "Dazzling Gleam" && pokemon.baseSpecies.baseSpecies === "Hatterene" || move.name === "False Surrender" && pokemon.baseSpecies.baseSpecies === "Grimmsnarl" || move.name === "Draining Kiss" && pokemon.baseSpecies.baseSpecies === "Alcremie" || move.name === "Heavy Slam" && pokemon.baseSpecies.baseSpecies === "Copperajah" || move.name === "Draco Meteor" && pokemon.baseSpecies.baseSpecies === "Duraludon" || move.name === "Wicked Blow" && pokemon.baseSpecies.baseSpecies === "Urshifu" || move.name === "Surging Strikes" && pokemon.baseSpecies.baseSpecies === "Urshifu")
              maxMove = gMaxMove;
          }
        }
      ...
      let maxNewPower = this.newMaxPower(move);
      maxMove.basePower = maxNewPower;
    ...
    getDynamaxRequest(skipChecks) {
      if (!skipChecks) {
        if (!this.side.canDynamaxNow())
          return;
        if (this.species.isMega || this.species.isPrimal || this.species.forme === "Ultra" || this.canMegaEvo || this.item !== "wishingstone") {
          return;
        }
