...
const Moves = {
  ...
  bellydrum: {
    ...
    basePower: 0,
    category: "Status",
    shortDesc: "User loses 50% max HP. Maxes Attack.",
    name: "Belly Drum",
    pp: 10,
    priority: 0,
    flags: { snatch: 1, metronome: 1 },
  ...
  mistyexplosion: {
    ...
    basePower: 100,
    category: "Special",
    shortDesc: "User feints. User on Misty Terrain: 1.5x power.",
  ...
  struggle: {
    ...
    basePower: 50,
    category: "Physical",
    shortDesc: "User loses 25% of its max HP.",
    name: "Struggle",
    pp: 1,
    noPPBoosts: true,
    priority: 0,
  ...
  terablast: {
    ...
    category: "Special",
    shortDesc: "No additional effect because Tera banned!!",
    name: "Tera Blast",
    pp: 10,
    priority: 0,
  ...
  thunderclap: {
    ...
    basePower: 70,
    category: "Special",
    shortDesc: "Usually goes first. Fails if the target is attacking.",
    name: "Thunderclap",
    pp: 5,
    priority: 1,
    flags: { protect: 1, mirror: 1, metronome: 1 },
