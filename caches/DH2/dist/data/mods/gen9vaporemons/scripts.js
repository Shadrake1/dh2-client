...
const Scripts = {
  ...
  pokemon: {
    ignoringAbility() {
      ...
      if (this.volatiles["gastroacid"])
        return true;
      if (this.volatiles["counteract"])
        return true;
      if (this.hasItem("Ability Shield") || this.ability === "neutralizinggas")
        return false;
      for (const pokemon of this.battle.getAllActive()) {
        if (pokemon.ability === "neutralizinggas" && !pokemon.volatiles["gastroacid"] && !pokemon.volatiles["counteract"] && !pokemon.transformed && !pokemon.abilityState.ending && !this.volatiles["commanding"]) {
          return true;
        }
      }
      return false;
    ...
    runEffectiveness(move) {
      ...
      if (this.hasAbility("exoskeleton") && !this.hasType("Bug") && this.battle.dex.getEffectiveness(move, "Bug") < 0)
        totalTypeMod--;
      if (this.volatiles["bluntforce"] && totalTypeMod > 0)
        return 0;
      return totalTypeMod;
    }
  },
  ...
  init() {
    ...
    delete this.modData("Learnsets", "ironmoth").learnset.meteorbeam;
    ...
    this.modData("Learnsets", "mewtwo").learnset.cuttingremark = ["9L1"];
    this.modData("Learnsets", "mewtwo").learnset.lashout = ["9L1"];
    this.modData("Learnsets", "mewtwo").learnset.rage = ["9L1"];
    this.modData("Learnsets", "mewtwo").learnset.tailslap = ["9L1"];
    this.modData("Learnsets", "groudon").learnset.desertstorm = ["9L1"];
    this.modData("Learnsets", "groudon").learnset.naturalgift = ["9L1"];
    this.modData("Learnsets", "groudon").learnset.rage = ["9L1"];
    this.modData("Learnsets", "groudon").learnset.ragingfury = ["9L1"];
    this.modData("Learnsets", "groudon").learnset.rekindle = ["9L1"];
    this.modData("Learnsets", "groudon").learnset.rockblast = ["9L1"];
    this.modData("Learnsets", "groudon").learnset.skullbash = ["9L1"];
    this.modData("Learnsets", "groudon").learnset.sledgehammerblow = ["9L1"];
    this.modData("Learnsets", "groudon").learnset.smackdown = ["9L1"];
    this.modData("Learnsets", "groudon").learnset.throatchop = ["9L1"];
    this.modData("Learnsets", "kyogre").learnset.washaway = ["9L1"];
    this.modData("Learnsets", "rayquaza").learnset.defog = ["9L1"];
    this.modData("Learnsets", "rayquaza").learnset.lashout = ["9L1"];
    this.modData("Learnsets", "rayquaza").learnset.psychicfangs = ["9L1"];
    this.modData("Learnsets", "rayquaza").learnset.windbreaker = ["9L1"];
    this.modData("Learnsets", "dialga").learnset.dragonrage = ["9L1"];
    this.modData("Learnsets", "dialga").learnset.echochamber = ["9L1"];
    this.modData("Learnsets", "dialga").learnset.rebuild = ["9L1"];
    this.modData("Learnsets", "dialga").learnset.shrapnelshot = ["9L1"];
    this.modData("Learnsets", "dialga").learnset.sledgehammerblow = ["9L1"];
    this.modData("Learnsets", "palkia").learnset.dragonrage = ["9L1"];
    this.modData("Learnsets", "palkia").learnset.meteorbeam = ["9L1"];
    this.modData("Learnsets", "giratina").learnset.choke = ["9L1"];
    this.modData("Learnsets", "giratina").learnset.dragonrage = ["9L1"];
    this.modData("Learnsets", "giratina").learnset.snatch = ["9L1"];
    this.modData("Learnsets", "giratina").learnset.windbreaker = ["9L1"];
    this.modData("Learnsets", "arceus").learnset.rage = ["9L1"];
    this.modData("Learnsets", "arceus").learnset.signalbeam = ["9L1"];
    this.modData("Learnsets", "zacian").learnset.chisel = ["9L1"];
    this.modData("Learnsets", "zacian").learnset.cuttingremark = ["9L1"];
    this.modData("Learnsets", "zacian").learnset.naturalgift = ["9L1"];
    this.modData("Learnsets", "zacian").learnset.peekaboo = ["9L1"];
    this.modData("Learnsets", "eternatus").learnset.hazardouswaste = ["9L1"];
    this.modData("Learnsets", "eternatus").learnset.latentvenom = ["9L1"];
    this.modData("Learnsets", "eternatus").learnset.snatch = ["9L1"];
    this.modData("Learnsets", "urshifu").learnset.chisel = ["9L1"];
    this.modData("Learnsets", "urshifu").learnset.choke = ["9L1"];
    this.modData("Learnsets", "urshifu").learnset.cuttingremark = ["9L1"];
    this.modData("Learnsets", "urshifu").learnset.parry = ["9L1"];
    this.modData("Learnsets", "urshifu").learnset.rage = ["9L1"];
    this.modData("Learnsets", "urshifu").learnset.snatch = ["9L1"];
    this.modData("Learnsets", "urshifurapidstrike").learnset.chisel = ["9L1"];
    this.modData("Learnsets", "urshifurapidstrike").learnset.choke = ["9L1"];
    this.modData("Learnsets", "urshifurapidstrike").learnset.cuttingremark = ["9L1"];
    this.modData("Learnsets", "urshifurapidstrike").learnset.parry = ["9L1"];
    this.modData("Learnsets", "urshifurapidstrike").learnset.rage = ["9L1"];
    this.modData("Learnsets", "koraidon").learnset.dragonrage = ["9L1"];
    this.modData("Learnsets", "koraidon").learnset.lashout = ["9L1"];
    this.modData("Learnsets", "koraidon").learnset.rage = ["9L1"];
    this.modData("Learnsets", "koraidon").learnset.rollout = ["9L1"];
    this.modData("Learnsets", "koraidon").learnset.stormthrow = ["9L1"];
    this.modData("Learnsets", "koraidon").learnset.throatchop = ["9L1"];
    this.modData("Learnsets", "miraidon").learnset.chainlightning = ["9L1"];
    this.modData("Learnsets", "miraidon").learnset.dragonrage = ["9L1"];
    this.modData("Learnsets", "miraidon").learnset.rollout = ["9L1"];
